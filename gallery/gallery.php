...
<body>
<header>
    <a href="index.html" class="header-brand">mnutt5</a>
    <nav>
        <ul>
...
<section class="gallery-links">
  ...
  <footer>
    ...
    <div class="footer-sm">
        <a href="#"><img src="img/youtube-symbol.png" alt="youtube icon"></a>
        <a href="#"><img src="img/twitter-logo-button.png" alt="youtube icon"></a>
        <a href="#"><img src="img/facebook-logo-button.png" alt="youtube icon"></a>
    </div>
 </footer>
  </div>       
</body>
